...
* @author Jose Roberto
*/
public class ModelVendasProduto {
    ...
    */
    ...
    public String toString(){
        return "ModelVendasProduto {" + "::idVendaProduto = " + this.idVendaProduto + "::produto = " + this.produto + "::vendas = " + this.vendas + "::venProValor = " + this.venProValor + "::venProQuantidade = " + this.venProQuantidade +  "}";
    }
}